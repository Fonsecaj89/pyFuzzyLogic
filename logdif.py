...
r = Reglas()
r.crear("if Temperatura is Baja and Clima is Nublado then Intencion is Dormir")
r.crear("if Temperatura is Fresco and Clima is Soleado then Intencion is Pasear")
r.crear("if Temperatura is Alta and Clima is Soleada then Intencion is No_Salir")
